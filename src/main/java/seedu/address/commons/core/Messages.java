...
import static seedu.address.model.healthworker.Healthworker.ORDERS_LIMIT;
...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_REQUEST_COMMAND_FORMAT = "Invalid request command format! \n%1$s";
    public static final String MESSAGE_INVALID_REQUEST_DISPLAYED_INDEX = "The request index provided is invalid";
    public static final String MESSAGE_PERSONS_LISTED_OVERVIEW = "%1$d persons listed!";
    public static final String MESSAGE_REQUESTS_LISTED_OVERVIEW = "%1$d requests listed!";
    public static final String MESSAGE_COMPLETED_REQUEST = "This request is already delivered to the customer.";
    ...
    public static final String MESSAGE_REQUEST_LIMIT_EXCEEDED = String.format(
        "You cannot assign more than %1$d request(s) to a healthworker.", ORDERS_LIMIT);
}
