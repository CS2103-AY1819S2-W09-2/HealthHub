...
|INDEX | Refers to the index number shown by the order / healthworker list command & it must be a positive integer 1, 2, 3, ... and no larger than 2147483647.
...
****
* If there is an order already assigned to a healthworker, order list cannot be cleared.
****
