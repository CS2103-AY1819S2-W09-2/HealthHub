...
The format of the `add` command is `/request add n/NAME p/PHONE a/ADDRESS f/FOOD dt/DATETIME`.
...
... Test case: `/request add n/John Lee p/98765432 a/311, Clementi Ave 2, #02-25, 612344 f/Roti Prata f/Ice Milo
