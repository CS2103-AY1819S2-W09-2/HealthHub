...
- Users being able to track food requests (visualise on a map) they have from customers
- Managing deliverymen and assigning requests to them
- Analysis of requests to display relevant statistics (request history, trending food etc.) to users
...
requests at a region. The dashboard shows statistics like the most popular food item and the request history
